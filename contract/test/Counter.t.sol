...
//         // Create a game
//         vm.prank(alice);
//         uint256 gameId = tycoon.createGame{value: STAKE_AMOUNT}(
//             "Alice", "PUBLIC", "hat", 2, GAME_CODE, STARTING_BALANCE, STAKE_AMOUNT, false
//         );
...
//     //         vm.prank(alice);
//     //         uint256 gameId =
//     //             tycoon.createGame{value: STAKE_AMOUNT}("Alice", "PRIVATE", "hat", 2, GAME_CODE, STARTING_BALANCE);
...
//         vm.prank(alice);
//         uint256 gameId = tycoon.createGame{value: STAKE_AMOUNT}(
//             "Alice", "PUBLIC", "hat", 3, GAME_CODE, STARTING_BALANCE, STAKE_AMOUNT, false
//         );
...
//         vm.prank(charlie);
//         // uint8 order = tycoon.joinGame{value: STAKE_AMOUNT}(gameId, "charlie", "boot", "");
...
//     //         vm.prank(alice);
//     //         uint256 gameId =
//     //             tycoon.createGame{value: STAKE_AMOUNT}("Alice", "PUBLIC", "hat", 3, GAME_CODE, STARTING_BALANCE);
...
//     //         vm.prank(alice);
//     //         uint256 gameId =
//     //             tycoon.createAIGame{value: STAKE_AMOUNT}("Alice", "PUBLIC", "hat", 1, GAME_CODE, STARTING_BALANCE);
...
//     //         vm.prank(alice);
//     //         uint256 gameId =
//     //             tycoon.createAIGame{value: STAKE_AMOUNT}("Alice", "PUBLIC", "hat", 1, GAME_CODE, STARTING_BALANCE); // 1 AI, total 2
