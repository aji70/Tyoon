// components/OfferTradeModal.tsx
import React from 'react';
import { TradeInputs } from '../types'; // Assume types are exported
...
interface OfferTradeModalProps {
  ...
  setSelectedRequestedProperties: React.Dispatch<React.SetStateAction<number[]>>;
  otherPlayersProperties: { id: number; name: string; ownerUsername: string; color: string }[];
