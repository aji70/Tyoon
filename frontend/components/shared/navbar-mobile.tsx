...
import { House, Volume2, VolumeOff, Menu, X, User, ShoppingBag } from 'lucide-react';
...
const NavBarMobile = () => {
  ...
  return (
    <>
      <motion.div className="fixed top-0 left-0 right-0 bg-[#0FF0FC] h-[3px] origin-left z-[70]" style={{ scaleX }} />
            ...
            <div className="p-6 pb-10">
              ...
              {!isConnected ? (
                ...
                <div className="mb-8 space-y-5">
                  <div className="p-5 rounded-2xl bg-[#011112]/80 border border-[#003B3E] flex items-center gap-4">
              ...
              {isConnected && (
                <button
                  onClick={() => { disconnect(); closeMobileMenu(); }}
