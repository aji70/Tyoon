          ...
          >
            <div className="w-full flex items-center justify-center relative mb-8">
              <div className="w-full flex flex-col items-center">
                ...
                <p className="text-[#F0F7F7] text-sm text-center">
            ...
            <div className="flex gap-3">
              <AnimationWrapper variant="slideLeft" delay={0.1}>
                <button
                  ...
                  className="w-full py-3 rounded-lg font-medium bg-[#0FF0FC]/80 hover:bg-[#0FF0FC]/40 text-[#0D191B] transition-colors"
                >
                  Disconnect
                </button>
              </AnimationWrapper>
              <AnimationWrapper variant="slideRight" delay={0.2}>
                <button
                  onClick={onClose}
                  className="w-full py-3 rounded-lg font-medium bg-[#0D191B] border border-[#0D191B] hover:border-[#0FF0FC] text-white transition-colors"
                >
                  Cancel
                </button>
              </AnimationWrapper>
